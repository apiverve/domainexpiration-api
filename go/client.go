// Package domainexpiration provides a Go client for the Domain Expiration API.
//
// For more information, visit: https://domainexpiration.apiverve.com?utm_source=go&utm_medium=readme
package domainexpiration
...
const (
	baseURL        = "https://api.apiverve.com/v1/domainexpiration"
	defaultTimeout = 30 * time.Second
)

// Client is the Domain Expiration API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Domain Expiration API client.
...
// Execute makes a request to the Domain Expiration API with typed parameters.
//
...
//   - domain (required): string - The domain to check the expiration date of [format: date]
