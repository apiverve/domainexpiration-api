...
namespace APIVerve\Domainexpiration;
...
/**
 * Client for the Domain Expiration API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://domainexpiration.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/domainexpiration';
    ...
    private const VALIDATION_RULES = [
        'domain' => ['type' => 'string', 'required' => true, 'format' => 'domain']
    ];
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DomainexpirationClient] {$message}\n";
        }
    }
}
