...
namespace APIVerve.API.DomainExpiration
{
    ...
    /// <summary>
    /// Client for the DomainExpiration API
    /// </summary>
    public class DomainExpirationAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/domainexpiration";
        ...
        {
            { "domain", new ValidationRule { Type = "string", Required = true, Format = "date" } }
        };
        ...
        public DomainExpirationAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DomainExpirationAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DomainExpirationAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DomainExpirationQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DomainExpirationQueryOptions options)
        {
        ...
        public ResponseObj Execute(DomainExpirationQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DomainExpirationQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DomainExpirationQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DomainExpirationQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DomainExpirationQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DomainExpirationQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DomainExpirationQueryOptions options)
        {
